...
> _Skill : section centrale du report — c'est ce que `/forge:sync` va consommer. Trois sous-tables. Chaque écart volontaire doit dire « prévu / réalisé / raison ». Si une raison se relie à une décision de review, citer le bloquant/important par numéro._
