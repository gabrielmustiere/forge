...
- `documentation/forge.md` → inventaire lisible (2 colonnes skill / rôle). À mettre à jour à chaque ajout/retrait/renommage de skill.
...
3. Ajouter une ligne (skill / rôle) dans `documentation/forge.md`
