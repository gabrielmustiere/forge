...
| `/workflow:estimate` | Chiffre le temps « tout compris » d'une story à facturer (feature, refacto, tech) : cadrage, implem, tests, review, doc, release (forfait fixe 30 min) → `estimate.md` (en heures, marge incluse, deux colonnes réf./avec IA) |
